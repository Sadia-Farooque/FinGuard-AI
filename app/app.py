...
class FinGuardApp:
    ...
    def _build_sidebar(self, parent):
        ...
        tk.Label(btn_area, text="Database integration — coming soon",
                 font=("Segoe UI", 7), fg="#2a3a55", bg=PANEL
                 ).pack(pady=(0, 4))
    ...
    def _db_placeholder(self):
        messagebox.showinfo(
            ...
            "Will support: MongoDB, PostgreSQL, MySQL, and CSV batch imports.\n\n"
            "Customer records can be loaded by Customer ID once connected.")
